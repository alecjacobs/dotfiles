...
export PS1="\e[44;40m 🔥 \e[0m\e[44;44m wk: $CURRENT_PROJECT_NAME \e[0m\e[30;42m pwd: \w \e[0m \e[32m\$(if [ -d ./.git ]; then git symbolic-ref -q --short HEAD; else echo "="; fi;)>\e[0m "
